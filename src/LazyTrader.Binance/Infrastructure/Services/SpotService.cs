...
internal class SpotService : ISpotService
{
	...
	public async Task<Order> CancelOco(string symbol, long? orderListId = null, string? listClientOrderId = null,
		string? newClientOrderId = null)
	{
	...
	public async Task<List<Order>> GetAllOco(long? fromId = null, long? startTime = null, long? endTime = null,
		int? limit = null)
	{
